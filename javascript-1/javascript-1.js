...
//CODE HERE
  let phone1 = new Phone('Apple', 'Bad', 4242, 'black', false )
  
  let phone2 = new Phone('SamSung', 'Aight', 6969, 'brown', false )
  
  let phone3 = new Phone('Google', 'Good', 9999, 'White', false )
